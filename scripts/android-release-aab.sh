...
echo "  5. Monetize → Products → Subscriptions → create bobble_pro_monthly + bobble_pro_annual"
echo "     Each: one base plan (IDs monthly / annual), optional trial offer, activate"
echo "     Base plan menu → Use for deprecated billing methods (safety net)"
echo "     RevenueCat: Only Android SDK v6+; products bobble_pro_*:monthly|annual"
